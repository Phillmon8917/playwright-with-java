...
public class ValidationHelper {
     ...
     * If the field does not have a native validation message, it will search for an error tooltip
     * or error message element adjacent to the field element and return its text content.
    ...
    public static String getValidationMessage(Page page, String fieldId) {
        try {
            ...
            LoggingUtil.error("getValidationMessage - Failed to get validation message for field: " + fieldId + ": " + err.getMessage());
            throw err;
        }
    }
}