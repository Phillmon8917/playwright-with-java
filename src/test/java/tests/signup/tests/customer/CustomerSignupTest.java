package tests.signup.tests.customer;
...
@Tag("guest")
@Tag("shard3")
public class CustomerSignupTest extends SignupBaseTest
{
    @Test
    @Tag("sanity")
    void verifySuccessfulCustomerSignup() throws Exception {
        ...
        LoggingUtil.info("Assertion Passed - Customer signup is successful");
    }
